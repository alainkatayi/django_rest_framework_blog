...
from .views import CreateSkillView, SkillsListView,SkillUpdateView,SkillDeletedView,CreateExperienceView,UpdateExperienceView, DeleteExperienceView, ListExperienceView,CreateCertificationView,UpdateCerticationView,DeleteCertificationView,ListCertificationsView,CertificationUniqueView,SkillUniqueView,ExperienceUniqueView
...
urlpatterns = [
    ...
    path('<int:pk>/skill/',SkillUniqueView.as_view(), name='unique-skill'),
    ...
    path('<int:pk>/experience/',ExperienceUniqueView.as_view(), name='unique-skill'),
